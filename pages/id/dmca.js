    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Madara.live is committed to respecting the intellectual
          ...
          <div className="w-[75%] text-2xl gap-7 flex flex-col my-[10rem]">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-3 text-[#cdcdcd]">
                <p>
                  Madara.live is committed to respecting the intellectual
                  property rights of others and complying with the Digital
              ...
              <p className="text-[#cdcdcd]">
                None of the files listed on Madara.live are hosted on our
                servers. All links point to content hosted on third-party
                websites. Madara.live does not accept responsibility for content
                ...
                <a
                  href="mailto:contact@Madara.live?subject=[Madara]%20-%20Your%20Subject"
