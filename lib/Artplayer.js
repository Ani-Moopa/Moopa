...
export default function Player({
  ...
  //   });
  //   artInstanceRef.current.seek = artInstanceRef.current.currentTime;
  // };
  ...
  //     }
  //     artInstanceRef.current.seek = watchdata.time;
  //   }
  // }, [watchdata]);

  // console.log(localStorage.getItem("autoplay") === true);
      ...
      settings: [
        {
          ...
          onSwitch: function (item) {
            item.tooltip =
              localStorage.getItem("autoplay") === "true" ? "ON" : "OFF";
